      ...
      <div class="container-fluid ">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <Link class="nav-link text-white ms-4" to={"/"}>Home</Link>
            <Link class="nav-link text-white " to={"/AboutUs"}>About Us</Link>
              </div>
            </div>
          </div>
      </nav>
...
<div className="d-flex flex-sm-col justify-content-between ">
  <form onSubmit={handleSubmit} class="auth-inner card bg-white text-black mx-auto ">
