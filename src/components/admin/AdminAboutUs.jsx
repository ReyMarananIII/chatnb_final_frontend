      ...
      <div className="auth-inner-aboutus card bg-white text-black ms-5">
          <div className="container-fluid">
            ...
            <p className="text-align-justify">
              ...
              graduating students and their Thesis/Capstone Projects through an
              innovative way of grading. The system was developed using Agile
              Development Methodology to simplify the software development scheme
              of the system. The system was evaluated based on ISO 9126 standard
              which showed that the criteria on efficiency ranked as the
              highest, followed by the functionality and maintainability,
              criteria for portability and lastly criteria for the reliability
              and usability of the system ranks as the lowest. The result of the
              evaluation of Online Thesis/ Capstone Project Defense Evaluation
              System showed that the developed system achieved its functional
        ...
        <div className="w-50 h-50  d-flex justify-content-center align-items-center">
          <img src={pegasusLogo} alt="ChatNB Logo" className="pegasus-logo img-fluid" />
        </div>
      </div>
    </div>
  );
